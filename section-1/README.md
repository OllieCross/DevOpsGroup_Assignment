...
Zadanie zahŕňa vytvorenie jednoduchej Python web appky `app.py` pomocou knižnice Flask. Cieľom je vytvoriť čo najefektívnejší a bezpečný Dockerimage využívajúci multi-stage build a otvorenie portu pre prístup návštevníkov web appky. Dockerimage je rozdelený na dve časti pre zabezpečenie malého a efektívneho imageu a aby výsledný image neobsahoval zbytočné nástroje, ktoré sú potrebné len pri inštalácii.
